  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved room as @room" do
        ...
        post :create, {:room => { "number" => "invalid value" }}, valid_session
        assigns(:room).should be_a_new(Room)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested room" do
        ...
        Room.any_instance.should_receive(:update).with({ "number" => "MyString" })
        put :update, {:id => room.to_param, :room => { "number" => "MyString" }}, valid_session
      end
