...
describe ShelvesController do
  ...
  describe "GET new" do
    it "assigns a new shelf as @shelf" do
      ...
      assigns(:shelf).should be_a_new(Shelf)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created shelf as @shelf" do
        post :create, {:shelf => valid_attributes}, valid_session
        assigns(:shelf).should be_a(Shelf)
        assigns(:shelf).should be_persisted
      end

      it "redirects to the created shelf" do
        post :create, {:shelf => valid_attributes}, valid_session
        response.should redirect_to(Shelf.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shelf as @shelf" do
        ...
        Shelf.any_instance.stub(:save).and_return(false)
        post :create, {:shelf => { "number" => "invalid value" }}, valid_session
        assigns(:shelf).should be_a_new(Shelf)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested shelf" do
        ...
        Shelf.any_instance.should_receive(:update).with({ "number" => "MyString" })
        put :update, {:id => shelf.to_param, :shelf => { "number" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the shelf" do
        shelf = Shelf.create! valid_attributes
        put :update, {:id => shelf.to_param, :shelf => valid_attributes}, valid_session
        response.should redirect_to(shelf)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the shelf as @shelf" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Shelf.any_instance.stub(:save).and_return(false)
        put :update, {:id => shelf.to_param, :shelf => { "number" => "invalid value" }}, valid_session
        assigns(:shelf).should eq(shelf)
      end
